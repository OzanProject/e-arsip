        ...
        <div class="flex flex-wrap gap-2 md:gap-3 justify-start md:justify-end">
            ...
            <div class="relative" x-data="{ openExport: false }">
                ...
                <div x-show="openExport" x-cloak 
                     ...
                     class="absolute right-0 md:left-0 md:right-auto lg:right-0 mt-2 w-48 bg-white rounded-xl shadow-2xl z-50 border border-slate-100 overflow-hidden">
            ...
            <a href="{{ route('nomor-surat.create') }}" class="inline-flex items-center px-5 py-2.5 bg-indigo-600 text-white font-semibold rounded-xl shadow-lg hover:bg-indigo-700 transition">
