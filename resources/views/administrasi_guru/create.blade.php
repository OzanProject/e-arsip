...
@section('title', 'Tambah Administrasi Guru')
            ...
            <div class="bg-white rounded-xl shadow-lg border-t-4 border-indigo-600 hover:shadow-2xl transition duration-300 ease-in-out"> 
                ...
                <div class="p-5 border-b border-slate-100">
                    <h3 class="text-xl font-bold text-slate-800 flex items-center">
                        <i class="fas fa-file-upload mr-2 text-indigo-600"></i> Form Arsip Administrasi Guru
                    </h3>
                </div>
                
                {{-- CARD BODY & FOOTER akan di-include dari partial form --}}
                @include('administrasi_guru.form', ['administrasiGuru' => null, 'ptkList' => $ptkList])
