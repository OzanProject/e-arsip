...
@section('title', 'Edit Administrasi Siswa')
            ...
            <div class="bg-white rounded-xl shadow-lg border-t-4 border-amber-500 hover:shadow-2xl transition duration-300 ease-in-out"> 
                ...
                <div class="p-5 border-b border-slate-100">
                    <h3 class="text-xl font-bold text-slate-800 flex items-center">
                        <i class="fas fa-file-edit mr-2 text-amber-500"></i> Form Edit Arsip: {{ $administrasiSiswa->judul }}
                    </h3>
                </div>
                
                {{-- CARD BODY & FOOTER --}}
                {{-- Memanggil Partial Form (Form akan otomatis menggunakan method PUT/PATCH) --}}
                @include('administrasi_siswa.form', [
                    'administrasiSiswa' => $administrasiSiswa,
                    'siswaList' => $siswaList
                ])
